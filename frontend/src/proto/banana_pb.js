...
proto.GameUpdate.prototype.clearSelfTileUpdate = function() {
  this.setSelfTileUpdate(undefined);
};
...
proto.GameUpdate.prototype.clearOtherTileUpdate = function() {
  this.setOtherTileUpdate(undefined);
};
...
proto.PlayerMove.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    wordValid: jspb.Message.getFieldWithDefault(msg, 4, false),
    boardConnected: jspb.Message.getFieldWithDefault(msg, 5, false)
  };
