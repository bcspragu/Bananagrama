...
proto.PeelRequest.prototype.getBoard = function() {
  return /** @type{?proto.Board} */ (
    jspb.Message.getWrapperField(this, proto.Board, 2));
};
...
proto.Word.toObject = function(includeInstance, msg) {
  var f, obj = {
    letters: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
/**
 * optional string letters = 1;
 * @return {string}
 */
proto.Word.prototype.getLetters = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.Word.prototype.setLetters = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
