...
$packages["github.com/bcspragu/Bananagrama/gopherjs"] = (function() {
	var $pkg = {}, $init, js, mapType, main;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	mapType = $mapType($String, $emptyInterface);
	main = function() {
		var $ptr;
		$global.Bananarama = $externalize($makeMap($String.keyFor, []), mapType);
	};
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
...
$synthesizeMethods();
var $mainPkg = $packages["github.com/bcspragu/Bananagrama/gopherjs"];
